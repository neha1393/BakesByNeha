...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:5173","https://bakes-by-neha.vercel.app","https://bakesbyneha.onrender.com","https://your-vercel-app.vercel.app","http://localhost:5174","https://bakes-by-neha-9fl1f5wv4-neha1393s-projects.vercel.app",
        "http://localhost:5175",
        "http://localhost:5176",
    ],
    allow_methods=["*"],
